-- Add AttackSpeed column to itemtypes table
-- AttackSpeed represents attacks per second (e.g., 2.0 = 2 attacks per second)

-- Add the column
ALTER TABLE itemtypes
ADD AttackSpeed DECIMAL(4,2) DEFAULT 1.0;
